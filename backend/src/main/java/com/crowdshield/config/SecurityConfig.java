...
import com.crowdshield.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    private final UserDetailsServiceImpl userDetailsService; // concrete type — no ambiguity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST,   "/track/ping").permitAll()
                .requestMatchers(HttpMethod.DELETE, "/track/**").permitAll()
                .requestMatchers(HttpMethod.GET,    "/track/**").permitAll()
                .requestMatchers(HttpMethod.GET,    "/risk/**").permitAll()
